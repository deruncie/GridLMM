...
- `GridLMM_GWAS_fast`: Runs a GWAS with the error structure a LMM. Uses heuristics to efficiently sample the grid. Can run Wald tests (`method = 'REML'`), Likelihood ratio tests (`method = 'ML'`), or calculate Bayes Factors (`method = 'BF'`)
- `GridLMM_GWAS`: Runs a GWAS as above, but with a complete grid
